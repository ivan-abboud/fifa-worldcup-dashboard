...
def generate_table_from_df(
    ...
    **table_kwargs : Keyword arguments
    ...
    table_header = html.Div(className="dataTables_scrollHead",children=[
                html.Table(className="dt-scrollableTable table table-bordered dataTable no-footer",
                children=[
                        table_header
                ])
            ])
    ...
    table_body = html.Div(
            ...
            children=[
                html.Table(className="dt-scrollableTable table table-bordered dataTable no-footer", children=[
                    html.Tbody(
                        [
                            html.Tr(
                                [html.Td(df.iloc[i, j], className="fw-semibold")
            ...
            ], style={"max-height": 300, "overflow": "auto" , "width":"100%"}
        )
